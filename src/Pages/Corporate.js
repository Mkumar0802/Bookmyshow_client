                ...
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div class="mt-8 overflow-hidden">
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="p-6 mr-2 rounded-lg shadow-xl bg-slate-400 max-w-sm hover:bg-slate-600  sm:rounded-lg">
                            ...
                            <form class="p-6 flex flex-col justify-center" ref={form} onSubmit={sendEmail}>
                                ...
                                <button type="submit" value="Send" onClick={addRecord} class=" bg-teal-700  text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-teal-800 transition ease-in-out duration-300">
                                    Submit
                                </button>
                                </div>
                            </form>
